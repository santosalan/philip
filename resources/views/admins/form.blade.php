...
@section('content_header')
    ...
    <div class="page-header">
        <h1>Admins <small>@if (Request::is('*/create')) {{ trans('laravel-crud::view.create') }} @else {{ trans('laravel-crud::view.edit') }} @endif</small></h1>
...
@section('content')
    ...
    @else
        <div class="box box-warning"> 
            {{ Form::model($admin, ['action' => ['AdminsController@update', $admin->id], 'method' => 'PATCH']) }}
    @endif
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-xs-12"> 
                        ...
                        {{ Form::text("name", @$admin->name, ["class" => "form-control", "placeholder" => trans('laravel-crud::view.name'), "maxlength" => "255", "required"]) }}
                    </div>

                    <div class="col-xs-12"> 
                        {{ Form::label("email", trans('laravel-crud::view.email'), ["class" => "control-label"]) }}
                        {{ Form::email("email", @$admin->email, ["class" => "form-control", "placeholder" => trans('laravel-crud::view.email'), "maxlength" => "255", "required"]) }}
                    </div>
